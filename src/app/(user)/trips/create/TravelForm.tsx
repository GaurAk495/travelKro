...
const formSchema = z.object({
  duration: z
    ...
    .max(14, "Max duration can be 2 weeks")
    .refine((val) => {
...
export default function TravelForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      const res = await CreateItineary({ reqBody });
      router.push(`/trips/${res}`);
    } catch (error) {
      console.error(error);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="max-w-md w-full mx-auto p-6 bg-white shadow border rounded-xl mb-16">
      <Form {...form}>
                ...
                <FormControl>
                  <Input
                    ...
                    onInput={(e) => {
                      ...
                      if (Number(value) > 14) {
                        e.currentTarget.value = String(14);
                      }
                    }}
                  />
                </FormControl>
